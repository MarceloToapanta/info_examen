...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\info_examen\\log/admin_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\info_examen\\cache\\admin\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\info_examen\\apps\\admin/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('usuario'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\info_examen\\cache\\admin\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\info_examen\\apps\\admin/template',
)));
